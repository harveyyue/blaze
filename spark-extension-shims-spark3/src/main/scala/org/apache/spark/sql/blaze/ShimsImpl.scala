...
class ShimsImpl extends Shims with Logging {
  ...
  @enableIf(Seq("spark312").contains(System.getProperty("blaze.shim")))
  override def shimVersion: String = "spark312"
  ...
  @enableIf(Seq("spark303", "spark312").contains(System.getProperty("blaze.shim")))
  override def commit(
      dep: ShuffleDependency[_, _, _],
      shuffleBlockResolver: IndexShuffleBlockResolver,
      tempDataFile: File,
  ...
  @enableIf(
    Seq("spark303", "spark312", "spark320", "spark324", "spark333").contains(
      System.getProperty("blaze.shim")))
  ...
  @enableIf(
    Seq("spark303", "spark312", "spark320", "spark324").contains(
      System.getProperty("blaze.shim")))
